...
export const ItemWoodenPickaxe: ItemDef = { id: 6, name: 'Wooden Pickaxe', stackable: false, maxStack: 1, iconColor: [205, 133, 63] }
export const ItemStonePickaxe: ItemDef = { id: 7, name: 'Stone Pickaxe', stackable: false, maxStack: 1, iconColor: [128, 128, 128] }
export const ItemIronPickaxe: ItemDef = { id: 8, name: 'Iron Pickaxe', stackable: false, maxStack: 1, iconColor: [200, 200, 200] }
