================================================================
RESUME — Signal Ascent / celestial (thin pointer)
================================================================
...
**ACCEPT / fantasy** only from Initial:
  `lab/examples/games/celestial-incremental.md`

Branch: `agent/celestial-inc-*` (PROGRESS / open PR). No greenfield. No `*-rebased`.
