...
- Phase: **Phase 8 in progress** — P8-1 ✅ (HitEffects + ScreenShake), P8-2 ✅ (Audio feedback), P8-3 ✅ (Toast polish), PR#86 + #87 (closed) + #88
...
| P8-3 | Toast system polish — stacked notifications, slide-in/out animations, configurable duration/type | ✅ SHIPPED PR#88 | `ToastSystem.ts`, `ui.ts`, `Transition.ts`, `index.html`, `styles.css`, `toast-system.test.ts` |
...
- **P8 remaining** — Dynamic lighting tweaks (torch flicker, ambient light falloff). Next step.
