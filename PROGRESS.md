...
- Phase: **Phase 12 complete** — Boss Trophy Tracking: toast on boss defeat, boss kill counter in HUD (👑), boss kill stat on death screen, RunTracker integration with persistent `_totalBossKills`. Gate: 341 tests green (2 skipped), 619.89 KB bundle.
