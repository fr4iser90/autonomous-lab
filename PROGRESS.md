...
- Milestone: M5 (Strata: layerDef 1–50, LayerEngine, save v2, simulateToLayer) — in progress
...
- Next: gate green → pre-PR visual (UI unchanged, reuse m4-play.png) → commit M5 → push → M6 Resonators
