/**
 * Signal Ascent — UI smoke (M4).
 * Title loads, Play works, Harvest click raises Signal, relay list renders,
...
console.log('UI SMOKE PASS (M4: title + play + 5 clicks -> Signal 5, buy Whisper @15 -> owned 1, rate +0.5/sec, production ticking, zero pageerror)')
