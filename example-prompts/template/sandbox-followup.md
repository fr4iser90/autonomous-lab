...
WHAT THIS JOB WAS
- Full overnight law: `sandbox.md` in `example-prompts/template/` (filled for this
...
- Kind: sandbox / open-world template
...
3. Obey LIVE LOOP from `sandbox.md` before every push/PR — including **PRE-PR VISUAL**
